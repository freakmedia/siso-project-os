...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="icon" href="data:,"><meta name="generator" content="siso-project-os@0.3.0/onboarding"><meta name="project-os-source-commit" content="${htmlEscape(snapshot.generation.source_commit ?? '')}"><meta name="project-os-input-digest" content="${htmlEscape(snapshot.generation.input_digest)}"><title>${htmlEscape(model.project_name)} · Project OS</title>
